      ...
      <div className={style.topBox}>
        ...
        <div className={style.textContainer}>
          ...
          <Typography variant="h4" color={'secondary'} maxWidth={480}>
            We love to see how you style your favourites from H&M: Keep sharing your personal style
            with @HM and #HMxME for a chance to be featured at hm.com, in our marketing materials
            and in our stores.
          </Typography>
          <Link to={Routes.shop}>
