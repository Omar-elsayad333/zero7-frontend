    ...
    return (
        <div className={`${style.container} grid`}> 
            ...
            <div className={style.bottomSection}>
                <img src={logo} width={100} alt='zero 7' />
                <div className={style.socialIcons}>
                    <a href={'https://www.facebook.com/zerooosevennn'} target='blank'>
                    ...
                    <a href="https://instagram.com/zero_seven.7?igshid=YmMyMTA2M2Y=" target='blank'>
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_60_315)">
