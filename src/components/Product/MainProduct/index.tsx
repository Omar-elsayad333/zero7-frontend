    ...
    return (
        <div className={style.container} key={data.productData._id}>
            <div className={style.imagesContainer} data-aos="fade-right" data-aos-duration="2000" data-aos-once='true'>
                {
                    ...
                    <>
                        <img src={states.selectedImages[0]} style={{maxWidth: '100%'}} alt={data.productData.name} />
                        <img src={states.selectedImages[1]} style={{maxWidth: '100%'}} alt={data.productData.name} />
                    </>
                }
            </div>
            <div className={style.detailsContainer} data-aos="fade-left" data-aos-duration="2000"  data-aos-once='true'>
                ...
                <Typography width={450} maxWidth={'100%'} variant='h3' color={'primary'}>
                ...
                <div className={style.buttonsAction}>
                    <PrimaryButton 
                        ...
                        content='Add To Cart'
                    />  
                    <svg onClick={(e) => actions.addToWishlist(e, data.productData._id)} className='wishlistIcons' data-id={data.productData._id} width="30" height="30" viewBox="0 0 24 25" fill={colors.primary.main} xmlns="http://www.w3.org/2000/svg">
