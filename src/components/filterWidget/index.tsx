        ...
        <div className={style.container}>
            <div className={style.filtersContainer} data-aos="fade-right" data-aos-duration="1000">
                <SelectInput 
                    ...
                    value={state.selectedGender.name || ''}
                ...
                <SelectInput 
                    ...
                    onChange={actions.handleSelectedCategory}
                />
            </div>
            ...
            <div onClick={() => actions.clearFilters()} className={style.filterControllers} data-aos="fade-left" data-aos-duration="1000">
